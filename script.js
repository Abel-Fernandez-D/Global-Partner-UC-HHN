const words = ["SANITATION", "SEWAGE", "INFRASTRUCTURE", "POLLUTION",  "ENVIRONMENT",  "PARTICULATE",  "CHEMICAL",  "SUSTAINABLE",  "REGULATION",  "EMISSION"];
const gridSize = 15;
...
function sharePage() {
    if (navigator.share) {
        navigator.share({
            title: "Clean Environment for a Good Health and well-being",
            text: "Learn about clean resources and SDG 7 with this fun word search game!",
